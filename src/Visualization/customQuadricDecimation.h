/*=========================================================================
  ...
  Module:    customQuadricDecimation.h
...
=========================================================================*/
// .NAME customQuadricDecimation - reduce the number of triangles in a mesh
// .SECTION Description
// customQuadricDecimation is a filter to reduce the number of triangles in
// a triangle mesh, forming a good approximation to the original geometry.
// The input to customQuadricDecimation is a vtkPolyData object, and only
...
#ifndef __customQuadricDecimation_h
#define __customQuadricDecimation_h
...
class VTKFILTERSCORE_EXPORT customQuadricDecimation : public vtkPolyDataAlgorithm
{
public:
  vtkTypeMacro(customQuadricDecimation, vtkPolyDataAlgorithm);
  void PrintSelf(ostream& os, vtkIndent indent);
  static customQuadricDecimation *New();
...
protected:
  ...
  int IsGoodIdea(vtkIdType pt0Id, vtkIdType pt1Id);
...
private:
  customQuadricDecimation(const customQuadricDecimation&);  // Not implemented.
  void operator=(const customQuadricDecimation&);  // Not implemented.
};
